...
public class TransferServiceImpl implements TransferService {
	...
	public Transfer save(Transfer transfer) {
		...
		Float transferFee = calculatePlayerTransferFee(fromTeam, toTeam, player);
	...
	public Float calculatePlayerTransferFee(Team fromTeam, Team toTeam, Player player) {
		...
		return baseFee + baseFee * (fromTeam.getCommission() / 100.0f);
	}
